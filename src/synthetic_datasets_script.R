...
### If true, plotting and logging occur
  ...
  write.table(mtrx_finalCounts, file=strSpikedBasisFileName, quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t")
  write.table( mtrxDataCounts,
               file = strBasisFileName,
               quote = FALSE,
               row.names = FALSE,
               col.names = FALSE,
               sep = "\t")
  write.table( as.matrix(vBasisStrParameters),
               file = strBasisParamFileName,
               quote = FALSE,
               row.names = FALSE,
               col.names = FALSE,
               sep = "\t")
